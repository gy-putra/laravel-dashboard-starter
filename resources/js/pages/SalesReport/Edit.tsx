...
export default function SalesReportEdit({ salesReport }: Props) {
    const { data, setData, put, processing, errors } = useForm<FormData>({
        date: salesReport.date,
        order_no: salesReport.order_no,
        customer_name: salesReport.customer_name,
        product: salesReport.product,
        quantity: salesReport.quantity,
        unit_price: salesReport.unit_price,
        subtotal: salesReport.subtotal,
        total: salesReport.total,
        notes: salesReport.notes || '',
        product_category: salesReport.product_category,
    });
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        put(`/sales-reports/${salesReport.id}`);
    };
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title={`Edit Laporan Omzet - ${salesReport.order_no}`} />
                ...
                <Card>
                    <CardHeader>
                        <CardTitle className="flex items-center gap-2">
                            ...
                            Edit Data Laporan Omzet - {salesReport.order_no}
                        </CardTitle>
                    </CardHeader>
                    <CardContent>
