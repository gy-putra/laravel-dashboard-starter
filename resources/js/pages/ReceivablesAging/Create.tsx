...
const breadcrumbs = [
    ...
    { title: 'Tambah Data', href: '/receivables-agings/create' },
];

export default function ReceivablesAgingCreate() {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Tambah Umur Piutang" />
